...
import com.example.myappointment.databinding.ActivityMapsBinding;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
                userLatLong = new LatLng(location.getLongitude(), location.getLongitude());
                mMap.clear();
    ...
    private void askLocationPermission() {
        Dexter.withActivity(this).withPermission(Manifest.permission.ACCESS_FINE_LOCATION).withListener(new PermissionListener() {
            ...
            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                ...
                userLatLong = new LatLng(lastlocation.getLongitude(), lastlocation.getLongitude());
                mMap.clear();
                mMap.addMarker(new MarkerOptions().position(userLatLong).title("Your Location"));
                mMap.moveCamera(CameraUpdateFactory.newLatLng(userLatLong));
            }
